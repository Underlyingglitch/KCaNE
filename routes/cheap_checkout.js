module.exports = function (app) {
  app.get('/cheap_checkout', (req, res) => {
  ...
  const lb_array = ['bananas', 'broccoli', 'chicken', 'grapefruit', 'lemons', 'lettuce', 'oranges', 'pork', 'potatoes', 'steak', 'tomatoes', 'turkey'];

  const btnpressed = [];
  const render_fields = ['hidden', 'hidden', 'hidden', 'hidden', 'hidden', 'hidden', 'hidden', 'hidden', 'hidden', 'hidden', 'hidden', 'hidden'];
  ...
  app.post('/cheap_checkout', (req, res) => {
    /* var size = 0, key;
    for (key in products) {

module.exports = function(app) {
  app.get('/keypads', function (req, res){
    res.render('keypads', {
      title: "",
      keypads: list,
      answer: outcome,
  ...
  var list = [];
  var outcome = [];
  app.post('/keypads', function (req, res) {
    var column1 = ["28-balloon", "13-at", "30-upsidedowny", "12-squigglyn", "7-squidknife", "9-hookn", "23-leftc"];
    var column2 = ["16-euro", "28-balloon", "23-leftc", "26-cursive", "3-hollowstar", "9-hookn", "20-questionmark"];
    var column3 = ["1-copyright", "8-pumpkin", "26-cursive", "5-doublek", "15-meltedthree", "30-upsidedowny", "3-hollowstar"];
    var column4 = ["11-six", "21-paragraph", "31-bt", "7-squidknife", "5-doublek", "20-questionmark", "4-smileyface"];
    var column5 = ["24-pitchfork", "4-smileyface", "31-bt", "22-rightc", "21-paragraph", "19-dragon", "2-filledstar"];
    var column6 = ["11-six", "16-euro", "27-tracks" , "14-ae", "24-pitchfork", "18-nwithhat", "6-omega"];
